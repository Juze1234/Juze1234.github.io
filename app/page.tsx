...
const content = {
  en: {
    ...
    caseIntro: "An independent multiplayer survival and roleplay project built on DayZ and set in the Metro 2033 universe. It combines underground exploration, survival pressure, roleplay systems, and a designed server economy. The two-person team consists of a world builder focused primarily on the map and Sergey as lead developer for the remaining systems and content. After two years in development, the project is preparing for its next closed beta.",
    facts: [
    ...
    about: [
      "Sergey is the lead developer of Metro W.A.R. RP. His work spans gameplay scripting, model integration, level design, game design, and multiplayer economy design. The project is built by a two-person team, with the second developer focused primarily on world and map production. Two years of development have grown into a 900+ member community, while the most recent major test sustained a full 80-player server.",
      "This portfolio is built around concrete work rather than abstract concepts. Each case study clearly separates personal contribution, team context, technical decisions, and the final player experience.",
    ],
  ...
  ru: {
    ...
    caseIntro: "Независимый многопользовательский проект о выживании и ролевой игре на платформе DayZ во вселенной Metro 2033. Он объединяет исследование подземного мира, давление механик выживания, ролевые системы и спроектированную серверную экономику. В команде два человека: один в основном занимается созданием карты, а Сергей как главный разработчик отвечает за остальные системы и контент. После двух лет разработки проект готовится к следующему закрытому бета-тесту.",
    ...
    about: [
      "Сергей — главный разработчик Metro W.A.R. RP. Его работа охватывает программирование игровых механик, интеграцию моделей, левел- и геймдизайн, а также проектирование экономики многопользовательского сервера. Проект создаётся командой из двух человек: второй разработчик в основном отвечает за мир и карту. За два года вокруг проекта выросло сообщество из 900+ участников, а последний крупный тест постоянно удерживал полный сервер на 80 игроков.",
      "Это портфолио построено вокруг конкретных результатов, а не абстрактных концепций. В каждом кейсе отдельно показаны личный вклад, контекст команды, технические решения и итоговый игровой опыт.",
    ],
